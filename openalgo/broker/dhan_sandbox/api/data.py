            ...
            if interval == "D":
                ...
                if start_date == (end_dt - timedelta(days=1)).strftime("%Y-%m-%d"):
                    ...
                    def fetch_chunk(chunk_start, chunk_end):
                        ...
                        logger.info(f"Making intraday history request to {endpoint} ({chunk_start} to {chunk_end})")
                    ...
                    # Use ThreadPoolExecutor to fetch chunks in parallel
                    with ThreadPoolExecutor(max_workers=4) as executor:
                        ...
                        for future in as_completed(future_to_chunk):
                            ...
                            if chunk_result:
                                all_candles.extend(chunk_result)
