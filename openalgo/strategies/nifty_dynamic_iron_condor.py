...
# If running from strategies root
if os.path.exists(os.path.join(script_dir, "utils")):
    utils_dir = os.path.join(script_dir, "utils")
    strategies_dir = os.path.dirname(script_dir) # openalgo
else:
    # Fallback to standard boilerplate logic (assuming subfolder)
    strategies_dir = os.path.dirname(script_dir) # openalgo/strategies (Wait, logic above was strategies_dir = dirname(script_dir))
    # If script is in strategies/subdir, dirname is strategies.
    # If script is in strategies/, dirname is openalgo.
    # The original boilerplate:
    # script_dir = strategies/subdir
    # strategies_dir = strategies
    # utils_dir = strategies/utils
