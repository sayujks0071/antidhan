...
class MCXStrategy:
    ...
    def calculate_indicators(self):
        ...
        df["upper_bb"] = df["sma"] + (df["std"] * self.params["std_dev"])
        df["lower_bb"] = df["sma"] - (df["std"] * self.params["std_dev"])
    ...
    def check_signals(self):
        ...
        # Exit Logic
            ...
            if current["close"] > current["upper_bb"] or current["rsi"] > 70:
                logger.info(f"EXIT: Mean Reversion Target Reached")
    ...
    def generate_signal(self, df):
        ...
        if current["close"] < current["lower_bb"] and current["rsi"] < 30:
            ...
            return "SELL", 1.0, {"reason": "exit_triggered"}
