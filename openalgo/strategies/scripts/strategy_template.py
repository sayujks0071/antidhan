...
try:
    ...
    # Fallback for development/testing when running from root
    # This handles cases where the script is run directly or imported for testing
    # and sys.path modification above might not work as expected in some environments
    try:
        ...
        # Last resort: try adding the repo root to path if we are in a subdirectory
