...
try:
    ...
    try:
        ...
        try:
            ...
            calculate_bollinger_bands = lambda s, p, d: (pd.Series(0, index=s.index), pd.Series(0, index=s.index), pd.Series(0, index=s.index))
...
class AIHybridStrategy:
    ...
    def calculate_signal(self, df):
        ...
        df['upper'], _, df['lower'] = calculate_bollinger_bands(df['close'], period=20, std_dev=2)
