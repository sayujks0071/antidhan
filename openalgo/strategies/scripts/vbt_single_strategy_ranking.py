...
def main():
    ...
    # In vectorbt, instantiating indicators with single parameters on a single symbol
    # without parameter arrays may return a scalar numpy.float64 rather than a pandas object
    if hasattr(total_returns, 'index'):
        # Just grab the first value if it's a series
