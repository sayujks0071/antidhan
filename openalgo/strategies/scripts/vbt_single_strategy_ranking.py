...
def main():
    # Set up single symbol and parameters
    symbol = "BTC-USD"
    ...
    # For a parameterless backtest on a single symbol, total_return() returns a scalar
    # Handle scalar or Series correctly
    if np.isscalar(total_returns) or isinstance(total_returns, float):
