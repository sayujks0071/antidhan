...
def main():
    ...
    # In vectorbt, if tested on a single symbol without parameter arrays,
    # pf.total_return() may return a scalar numpy.float64 rather than a pandas object with an .index attribute.
