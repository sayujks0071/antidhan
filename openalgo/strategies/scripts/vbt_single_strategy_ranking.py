...
def main():
    ...
    # yfinance Ticker initialization (like session, etc.)
    ...
    # For a single symbol and parameterless strategy in vbt 0.28+,
    # total_return() should be a scalar float (numpy.float64).
