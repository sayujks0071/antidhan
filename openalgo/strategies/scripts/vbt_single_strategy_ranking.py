...
def main():
    ...
    print("Running Dual SMA Crossover Backtest for Single Strategy...")
    # Define SMA windows
    fast_window = 10
    slow_window = 50
    ...
    # In vectorbt 0.28+, single parameter evaluations without parameter arrays
    # often return a scalar for metrics.
    if hasattr(total_returns, 'index'):
        # Just in case it returns a pandas Series with an index
