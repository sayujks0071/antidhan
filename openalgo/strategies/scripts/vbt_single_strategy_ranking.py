...
def main():
    ...
    # Download data
    # ticker_kwargs in YFData for v0.28+
    ...
    # Check if total_returns is a Series or a scalar float (numpy.float64)
    # Since we are using a single symbol without parameter arrays, total_returns might be a scalar
