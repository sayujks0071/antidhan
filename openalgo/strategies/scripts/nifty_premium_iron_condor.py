...
Enters after 10 AM when straddle premium > 120, sells OTM2, buys OTM4, manages exits by 40% SL, 50% TP, and 45-min hold.
"""
import os
import sys
import time
...
ENTRY_END_TIME = os.getenv("ENTRY_END_TIME", "15:00")
...
class NiftyPremiumIronCondorStrategy:
    def __init__(self):
        ...
        self.current_date = datetime.now(ist_offset).date()
